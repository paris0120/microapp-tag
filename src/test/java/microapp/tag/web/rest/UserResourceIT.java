...
import microapp.tag.config.Constants;
import microapp.tag.domain.Authority;
import microapp.tag.domain.UserTag;
import microapp.tag.repository.AuthorityRepository;
import microapp.tag.repository.EntityManager;
import microapp.tag.repository.UserRepository;
import microapp.tag.security.AuthoritiesConstants;
import microapp.tag.service.dto.AdminUserDTO;
import microapp.tag.service.mapper.UserMapper;
...
class UserResourceIT {
     ...
     */
    public static UserTag createEntity(EntityManager em) {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            ...
            em.deleteAll(UserTag.class).block();
        } catch (Exception e) {
     ...
     */
    public static UserTag initTestUser(UserRepository userRepository, EntityManager em) {
        userRepository.deleteAllUserAuthorities().block();
        userRepository.deleteAll().block();
        UserTag user = createEntity(em);
    ...
    void testUserEquals() throws Exception {
        TestUtil.equalsVerifier(UserTag.class);
        UserTag user1 = new UserTag();
        user1.setId(DEFAULT_ID);
        UserTag user2 = new UserTag();
    ...
    private void assertPersistedUsers(Consumer<List<UserTag>> userAssertion) {
