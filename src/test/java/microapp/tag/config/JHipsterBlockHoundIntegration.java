...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("microapp.tag.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("microapp.tag.security.DomainUserDetailsService", "createSpringSecurityUser");
