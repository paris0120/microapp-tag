...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './server.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVER actions', async () => {
      const expectedActions = [
        {
