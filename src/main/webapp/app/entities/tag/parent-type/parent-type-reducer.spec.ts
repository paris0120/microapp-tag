...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARENTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARENTTYPE actions', async () => {
      const expectedActions = [
        {
