...
export const TagDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tagApp.tagTag.delete.question">
        <Translate contentKey="tagApp.tagTag.delete.question" interpolate={{ id: tagEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="microapp-confirm-delete-tag" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
