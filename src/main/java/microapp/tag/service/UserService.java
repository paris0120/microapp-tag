...
import microapp.tag.security.SecurityUtils;
...
public class UserService {
    ...
    @Transactional
    public Mono<UserTag> saveUser(UserTag user) {
        return saveUser(user, false);
    }

    @Transactional
    public Mono<UserTag> saveUser(UserTag user, boolean forceCreate) {
        return SecurityUtils
            .getCurrentUserLogin()
    ...
    @Transactional(readOnly = true)
    public Mono<UserTag> getUserWithAuthoritiesByLogin(String login) {
    ...
    private Mono<UserTag> syncUserWithIdP(Map<String, Object> details, UserTag user) {
    ...
    public Mono<AdminUserDTO> getUserFromAuthentication(AbstractAuthenticationToken authToken) {
        ...
        UserTag user = getUser(attributes);
        user.setAuthorities(
            authToken
                .getAuthorities()
                .stream()
    ...
    private static UserTag getUser(Map<String, Object> details) {
