...
/**
 * Converter between {@link Row} to {@link UserTag}, with proper type conversions.
 */
@Service
public class UserRowMapper implements BiFunction<Row, String, UserTag> {
     ...
     * @return the {@link UserTag} stored in the database.
     */
    @Override
    public UserTag apply(Row row, String prefix) {
